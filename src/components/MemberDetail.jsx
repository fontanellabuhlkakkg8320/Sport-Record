    ...
    <section className="soft-card rounded-[2rem] bg-white p-6">
      <div className="mb-4 flex items-center gap-3">
        ...
        <div>
          ...
          <h2 className="text-2xl font-extrabold text-slate-800">{member.name}的健康计划</h2>
        </div>
      </div>

      <div className="mb-5 rounded-[1.5rem] bg-gradient-to-br from-sky-50 to-cyan-50 p-4">
